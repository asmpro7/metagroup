...
#' @param cor A vector of correlation coefficients.
#' @param n A vector of corresponding sample sizes.
#' @param studlab A vector of study labels.
#' @param ... Additional arguments passed on to `meta::metacor`.
#'
#' @details
...
#' the final `metacor` model (`model`), and the number of attempts (`attemps`).
#'
